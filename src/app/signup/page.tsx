    ...
    <div className="h-screen flex justify-center items-center">
      <div className="w-1/3">
        <div>
          ...
          <h1 className="text-center text-3xl font-serif mb-5 font-semibold">Sign Up</h1>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Type Uniqe Username" {...field} />
                    </FormControl>
                    <FormDescription>
                      <FormMessage />
                    </FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Type Strong Password" {...field} />
                    </FormControl>
                    <FormDescription>
                      <FormMessage />
                    </FormDescription>
              ...
              <div>
                ...
                <Link href={"/login"}><Button variant="link" className="ml-2">Already have an account <MoveRight /> </Button></Link>
              </div>
            </form>
          </Form>
        </div>
